...
{
    class KickVideoResponseChannel
    {
        [JsonProperty("slug")]
        public string Name { get; set; }
    }
    class KickVideoResponseLivestream
    {
        ...
        public KickVideoResponseChannel Channel { get; set; }
    }

    class KickVideoResponse
    {
        [JsonProperty("livestream")]
        public KickVideoResponseLivestream Livestream { get; set; }
    ...
    {
        [DllImport("tls-client/tls-client-windows-64-1.5.0.dll", CallingConvention = CallingConvention.Cdecl)]
        ...
        public KickService(Dictionary<string, string> headers = null, string TlsClientIdentifier = "Chrome110", int TimeoutSeconds = 30, bool FollowRedirects = false, string proxy = null)
        {
